...
const Sidebar = [
  ...
  { id: 2, name: "My Tournaments", icon: TrophyIcon, link: "/dashboard/mytournaments" },
  { id: 3, name: "Schedule", icon: CalendarDotsIcon, link: "/dashboard/schedule" },
  { id: 4, name: "Leaderboard", icon: CrownIcon, link: "/dashboard/leaderboard" },
  { id: 5, name: "Contact Us", icon: UserIcon, link: "/dashboard/contact" },
];

export default function MyTournamentsLayout({
  children,
}: {
    ...
    <AuthGuard>
      <div className="flex h-screen bg-[#0B1120] overflow-hidden">
        ...
        <div className="flex flex-col h-full w-full flex-1">
          <main className="flex-1 w-full min-h-screen overflow-y-scroll text-white md:ml-0 scrollbar-none">
            {children}
          </main>
          <Toaster />
        </div>
